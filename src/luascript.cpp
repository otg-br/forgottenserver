...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(L, RETURNVALUE_QUIVERAMMOONLY);
	registerEnum(L, RETURNVALUE_PREYINTERNALERROR);
	registerEnum(L, RETURNVALUE_NOTENOUGHMONEYFORREROLL);
	registerEnum(L, RETURNVALUE_NOAVAILABLEBONUSREROLL);
